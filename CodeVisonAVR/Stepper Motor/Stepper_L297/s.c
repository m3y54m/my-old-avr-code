...
#define HALF_FULL PORTC.1
#define CW_CCW PORTC.2
#define ENABLE PORTC.3
#define CONTROL PORTC.4
...
void driveMode(unsigned char dmode) 
{
switch (dmode)
{
 case 0:
...
while (1)
      ...
      switch (m) {
            case 0:
                  lcd_puts("One Phase On"); break;
            case 1:
                  lcd_puts("Two Phase On"); break;
            case 2:
                  lcd_puts("Half Step"); break;            
      }
      }
}
