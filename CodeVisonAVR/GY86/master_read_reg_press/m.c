...
#define TWI_SLAVE_ADDR 0b1110110
...
interrupt [TWI] void twi_interrupt(void)
{
   ...
   printf("  STATUS:%X-TWWC:%d-TR:%d\r\n",twi_status,(TWCR & (1<<TWWC))>>TWWC,TR);
   ...
   {  
      ...
      case 0x18:
         ...
         twi_tx_flag = 1;
         TWCR = (1<<TWINT) | (1<<TWEN) | (1<<TWIE);
         printf("\r\n%d.Register Address (HEX):%X\r\n",twi_tx_buffer,twi_tx_buffer);
         break;
