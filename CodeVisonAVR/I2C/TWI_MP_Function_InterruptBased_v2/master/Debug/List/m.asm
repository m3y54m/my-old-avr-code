...
_0x0:
	...
	.DB  0x74,0x65,0x64,0x3D,0x25,0x64,0x0,0x52
	.DB  0x65,0x63,0x65,0x69,0x76,0x65,0x64,0x3D
	.DB  0x25,0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
...
SUBOPT_0x1:
	MOV  R26,R4
	LDI  R27,0
	SUBI R26,LOW(-_twi_rx_buffer)
	SBCI R27,HIGH(-_twi_rx_buffer)
	IN   R30,0x3
	ST   X,R30
	RET
