...
void lcd_sendChar(uint8_t);												//forms data ready to send to LCD
void lcd_sendCommand(uint8_t);											//forms data ready to send to LCD
void lcd_init(void);													//Initializes LCD
void lcd_clear(void);													//Clears LCD
void lcd_home(void);													//LCD cursor home
void lcd_string(char *, uint8_t);										//Outputs string to LCD
void lcd_gotoxy(uint8_t, uint8_t);										//Cursor to X Y position
void lcd_puts(const char *, uint8_t, uint8_t);		//copies flash string to LCD at x,y
void lcd_defineChar(const char *, uint8_t);							//write char to LCD CGRAM
